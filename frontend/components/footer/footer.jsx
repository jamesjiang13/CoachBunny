...
const Footer = () => (
  <footer className={classes.footerMain}>
    <div className={classes.footerMainDiv}>
      ...
      <a target="_blank" href="https://github.com/jamesjiang13/CoachBunny">
        <img className={classes.imgResponsive} src={window.githubLogo} alt="git" />
      </a>
      <a target="_blank" href="https://www.linkedin.com/in/james-jiang-b962a245/" className={classes.lnkdLogo}>
